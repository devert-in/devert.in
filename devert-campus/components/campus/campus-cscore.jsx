...
// subjectIcon() moved to @/lib/subjectIcon - shared with devert-frontend's
// admin CS Core editor, which needed this same lookup without pulling in
// this whole file's campus-only dependencies (campusSearch, graded-quiz,
// campus-practice). Re-exported here so existing internal imports of
// subjectIcon from this file keep working unchanged.
export { subjectIcon };
