    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
          <Link href={`/${slug}/manage/students`} className="block">
          ...
          <Link href={`/${slug}/manage/contests?view=studio`} className="block">
            <CampusCard hover className="p-3.5 flex flex-col items-center text-center gap-1.5">
          ...
          <Link href={`/${slug}/manage/daily-learning?editDay=new`} className="block">
            <CampusCard hover className="p-3.5 flex flex-col items-center text-center gap-1.5">
          ...
          <Link href={`/${slug}/manage/branding`} className="block">
            <CampusCard hover className="p-3.5 flex flex-col items-center text-center gap-1.5">
      ...
      {contestBuckets.upcoming.length + contestBuckets.live.length > 0 && (
        <div>
          <SectionHeading icon={Trophy} title="Upcoming Contests"
            action={<Link href={`/${slug}/manage/contests`} className="text-[11px] font-semibold" style={{ color: CAMPUS.teal }}>View all &rarr;</Link>} />
      ...
      <div className="grid lg:grid-cols-2 gap-5">
        <div>
          <SectionHeading icon={UserPlus} title="Pending Approvals"
            action={<Link href={`/${slug}/manage/students`} className="text-[11px] font-semibold" style={{ color: CAMPUS.teal }}>View all &rarr;</Link>} />
          {pending === null ? (
        ...
        <div>
          <SectionHeading icon={Award} title={`Leaderboard Snapshot - ${metricLabel}`}
            action={<Link href={`/${slug}?tab=leaderboard`} className="text-[11px] font-semibold" style={{ color: CAMPUS.teal }}>View full &rarr;</Link>} />
          {leaderboard === null ? (
            ...
            columns={[
              ...
              { key: "studentCount", label: "Students", sortable: true },
              {
                key: "view", label: "", render: (row) => (
                  <Link href={`/${slug}/manage/students/classrooms?year=${encodeURIComponent(row.year)}&dept=${encodeURIComponent(row.department)}&section=${encodeURIComponent(row.section)}`}
