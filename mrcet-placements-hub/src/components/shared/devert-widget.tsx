    ...
    <Card className="glass border-gold-500/30 bg-navy-gradient text-white">
      <CardHeader>
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="text-white">Prep Smarter on Devert Placements Prep</CardTitle>
        </div>
      </CardHeader>
      <CardContent className="flex flex-col gap-4">
        <p className="text-sm text-white/75">
          {companyName
            ? `Preparing for ${companyName}? Solve curated company-specific mock tests and coding sheets now on Devert's Placements Prep portal.`
            : "Solve curated company-specific mock tests and coding sheets now on Devert's Placements Prep portal."}
        </p>
        <a
