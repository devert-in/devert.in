...
export default function ProfilePage() {
  ...
  // Re-encoding through a canvas (instead of uploading the raw file) discards
  // EXIF metadata - including GPS coordinates some phones embed - before it
  // ever reaches a publicly-readable bucket, and shrinks oversized photos.
