...
export default function ExecutionAiPage() {
    ...
    const LEARNER_TYPES = [
        {
            ...
            prompt: "I am stuck in tutorial hell, watching endless videos but never building. Evaluate my execution reality.",
        ...
        },
        {
            ...
            prompt: "I never ship because I want my code to be perfect. I endlessly refactor. Evaluate my execution reality.",
        ...
        },
        {
            ...
            prompt: "I have a billion-dollar idea but haven't written a line of code. Evaluate my execution reality.",
        ...
        },
        {
            ...
            prompt: "I keep planning to start 'tomorrow'. Evaluate my execution reality.",
        ...
        },
        {
            ...
            prompt: "I switch stacks every week (React to Vue to Svelte). Evaluate my execution reality.",
    ...
    const FALLBACK_RESPONSES = {
        tutorial_hell: {
            ...
            realityScore: { technicalFeasibility: 85, marketDemand: 0, executionComplexity: 90, timeReality: 10, riskLevel: 95 },
            ...
            executionBreakdown: { mve: "A generic To-Do App (No Tutorial)", dependencies: ["Zero YouTube", "Official Docs Only"] },
        ...
        perfectionist: {
            ...
            realityScore: { technicalFeasibility: 95, marketDemand: 20, executionComplexity: 100, timeReality: 5, riskLevel: 80 },
            ...
            executionBreakdown: { mve: "A broken, ugly MVP", dependencies: ["Accepting bugs", "Public release"] },
        ...
        dreamer: {
            ...
            realityScore: { technicalFeasibility: 0, marketDemand: 50, executionComplexity: 100, timeReality: 0, riskLevel: 100 },
            verdict: { decision: "WAKE UP", reason: "Ideas are worthless. Execution is the only currency that matters. You are currently bankrupt." },
            executionBreakdown: { mve: "One button that does one thing", dependencies: ["Learning to code", "Hiring a dev"] },
        ...
        procrastinator: {
            ...
            realityScore: { technicalFeasibility: 50, marketDemand: 50, executionComplexity: 10, timeReality: 0, riskLevel: 90 },
            verdict: { decision: "DO IT NOW", reason: "Tomorrow is a fantasy. You are wasting the only asset you cannot recover: Time." },
            executionBreakdown: { mve: "Hello World", dependencies: ["Discipline", "Starting"] },
        ...
        stack_switcher: {
            ...
            realityScore: { technicalFeasibility: 70, marketDemand: 10, executionComplexity: 80, timeReality: 20, riskLevel: 70 },
            verdict: { decision: "PICK ONE", reason: "You are avoiding the hard work of mastery by chasing the dopamine of novelty." },
            executionBreakdown: { mve: "Complete App in ONE Stack", dependencies: ["Commitment", "Boredom tolerance"] },
    ...
    const handleAnalysis = async (inputText, typeId = null) => {
        ...
        try {
            ...
            if (!response.ok) throw new Error("Execution Protocol Failed");
        ...
        <div className="min-h-screen bg-[#050505] text-white pt-28 pb-12 px-4 md:px-8 font-mono relative overflow-x-hidden">
            ...
            <div className="max-w-5xl mx-auto relative z-10">
                ...
                <div className="mb-12 text-center">
                    ...
                    >
                        <Brain size={14} />
                        <span>DEVERT_AI // EXECUTION_MODE</span>
                    </motion.div>
                            ...
                            <div className="grid md:grid-cols-3 gap-6">
                                ...
                                <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                    <h3 className="font-bold text-sm text-blue-400 mb-4 flex items-center gap-2">
                                        <Zap size={16} /> EXECUTION REQ
                                    </h3>
                                    <div className="space-y-4 text-sm">
                                        <div>
                                            <span className="text-gray-500 text-xs block mb-1">MVE</span>
                                            <p className="text-gray-300">{report.executionBreakdown?.mve}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex justify-between text-xs mt-2">
                                            ...
                                            <span className="text-white font-bold">{report.realityScore?.executionComplexity}%</span>
                                        </div>
                                        <div className="w-full bg-white/10 h-1 rounded-full overflow-hidden">
                                            <div className="bg-yellow-500 h-full" style={{ width: `${report.realityScore?.executionComplexity}%` }}></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
