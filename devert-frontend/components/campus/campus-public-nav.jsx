    ...
    columns: [
      {
        title: "Tracks",
        links: [
          { label: "Programming", href: "/campus/learning?tab=programming", icon: CodeXml, hint: "One curriculum per language" },
          { label: "CS Core", href: "/campus/learning?tab=csCore", icon: BrainCircuit, hint: "OS, DBMS, networks, OOP" },
          { label: "Fundamentals", href: "/campus/learning?tab=fundamentals", icon: Layers, hint: "How software is really built" },
          { label: "Aptitude", href: "/campus/learning?tab=aptitude", icon: Calculator, hint: "Quant, logical and verbal" },
        ],
      },
      {
        title: "Also here",
        links: [
          { label: "Courses", href: "/campus/learning?tab=courses", icon: GraduationCap, hint: "Guided, enrollable paths" },
          { label: "DSA Concepts", href: "/campus/practice?mode=concepts", icon: BookOpen, hint: "Theory before the problems" },
        ],
      },
    ],
    featured: {
    ...
    columns: [
      {
        title: "Solve",
        links: [
          { label: "DSA Problems", href: "/campus/practice", icon: Code2, hint: "Graded on real test cases" },
          { label: "DSA Sheets", href: "/campus/practice?mode=sheets", icon: ListChecks, hint: "Curated, ordered curricula" },
          { label: "DSA Concepts", href: "/campus/practice?mode=concepts", icon: BookOpen, hint: "Visualised roadmaps" },
        ],
      },
      {
        title: "Interviews",
        links: [
          { label: "Company Vault", href: "/campus/practice?mode=companyPrep", icon: Briefcase, hint: "Round-by-round breakdowns" },
          { label: "Contests", href: "/campus/contests", icon: Trophy, hint: "Open, timed and ranked" },
        ],
      },
    ],
    featured: {
      ...
      href: "/campus/practice", cta: "Open Practice",
    },
  },
    ...
    columns: [
      {
        title: "For students",
        links: [
          { label: "Find your college", href: "/campus/campuses", icon: Building2, hint: "Every live campus" },
          { label: "What a campus adds", href: "/campus/institutions", icon: Sparkles, hint: "Beyond the open tracks" },
        ],
      },
      {
        title: "For colleges",
        links: [
          { label: "Solutions by role", href: "/campus/institutions", icon: Users, hint: "Principal to placement cell" },
          { label: "Campus licence", href: "/campus/pricing", icon: ShieldCheck, hint: "How it is quoted" },
        ],
      },
    ],
    featured: {
      ...
      href: "/campus/campuses", cta: "Browse campuses",
    },
  },
  {
    ...
    columns: [
      {
        title: "The workspace",
        links: [
          { label: "Solutions by role", href: "/campus/institutions", icon: Users, hint: "Six roles, one workspace" },
          { label: "Daily Learning", href: "/campus/institutions", icon: ClipboardCheck, hint: "Schedule the weekly plan" },
          { label: "Assessments & contests", href: "/campus/institutions", icon: Trophy, hint: "Run and grade your own" },
        ],
      },
      {
        title: "Getting started",
        links: [
          { label: "Licence & pricing", href: "/campus/pricing", icon: LineChart, hint: "Quoted per institution" },
    ...
    featured: {
      ...
      href: "/campus/institutions", cta: "See the platform",
    },
  },
...
function ProfileFlyout({ open, onClose }) {
  ...
  const tiles = user
    ? [
        ...
        { icon: LayoutDashboard, label: "My campus", href: "/campus/campuses" },
      ]
    : [
        { icon: BookOpen, label: "Start learning", href: "/campus/learning" },
        { icon: Code2, label: "Solve problems", href: "/campus/practice" },
        { icon: Trophy, label: "Coding contests", href: "/campus/contests" },
        { icon: Building2, label: "Find your college", href: "/campus/campuses" },
      ];

  const included = [
    { icon: CodeXml, label: "Programming tracks" },
    { icon: BrainCircuit, label: "CS Core subjects" },
    { icon: Code2, label: "DSA problem set" },
    { icon: Briefcase, label: "Company Vault" },
    { icon: Calculator, label: "Aptitude practice" },
  ];
